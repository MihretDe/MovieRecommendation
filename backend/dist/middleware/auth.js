...
exports.authenticateTokenDev = exports.authenticateTokenUserInfo = exports.authenticateToken = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const jwks_rsa_1 = __importDefault(require("jwks-rsa"));
// Add this check before using process.env.AUTH0_DOMAIN
if (!process.env.AUTH0_DOMAIN) {
    throw new Error("AUTH0_DOMAIN environment variable is not set. Please check your .env file or deployment environment.");
}
...
const authenticateTokenUserInfo = async (req, res, next) => {
    ...
    try {
        ...
        console.log("🔗 Userinfo URL:", `https://${process.env.AUTH0_DOMAIN}/userinfo`);
        ...
        console.error("❌ UserInfo verification failed:", error.response?.data || error.message);
...
exports.authenticateTokenUserInfo = authenticateTokenUserInfo;
...
exports.authenticateTokenDev = authenticateTokenDev;
